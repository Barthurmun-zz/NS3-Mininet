...
class WIFISegment( object ):
	...
	#setting channel:
        ...
        # self.address = ns.internet.Ipv4AddressHelper ()
        # self.address.SetBase (ns.network.Ipv4Address ("192.168.123.0"), ns.network.Ipv4Mask ("255.255.255.0"))
            
    def add( self, node, port=None, intfName=None, mode=None, internet=False):
        """Connect Mininet node to the segment.
        ...
        #dev = self.wifihelper.Install( self.phyhelper, self.machelper, node.nsNode )
        device = self.wifihelper.Install( self.phyhelper, self.machelper, node.nsNode )
        ...
        if internet == True:
            self.stack.Install (node.nsNode)
            self.address.Assign (device)
            
            test = node.nsNode.GetObject(ns.internet.Ipv4.GetTypeId())
            adr = test.GetAddress (1,0).GetLocal()
            ns.network.InetSocketAddress(9998).SetTos(0xc0)
            ns.network.InetSocketAddress(9999).SetTos(0xb8)

            # tid = ns.core.TypeId.LookupByName ("ns3::UdpSocketFactory")
            # source = ns.network.Socket.CreateSocket (node.nsNode, tid)
            # source.SetIpTos (0xc0)
        
        # In the specified Mininet node, create TBIntf bridged with the 'device'.
        tb = TBIntf( intfName, node, port, node.nsNode, device.Get( 0 ), mode )
        return tb
    ...
    def addAp( self, node, port=None, intfName=None, mode=None,ext=None,ca=False, ssid="default-ssid", qosSupported=False, internet=False):
        """Connect Mininet node to the segment.
        ...
        if ca == True:
            self.machelper.SetType ("ns3::ApWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)),"BE_MaxAmsduSize", ns.core.UintegerValue (amsduVOBE),
            ...
            self.machelper.SetType ("ns3::ApWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)), "BE_MaxAmsduSize", ns.core.UintegerValue (0),
            ...
            self.machelper.SetType ("ns3::ApWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)))
        
        return self.add( node, port, intfName, mode, internet)

    def addSta( self, node, port=None, intfName=None, mode=None,ext=None, ca=False, ssid="default-ssid", qosSupported=False, internet=False):
        """Connect Mininet node to the segment.
        ...
        if ca == True:
            self.machelper.SetType ("ns3::StaWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)), "BE_MaxAmsduSize", ns.core.UintegerValue (amsduVOBE),
                                    "BK_MaxAmsduSize", ns.core.UintegerValue (amsduVIBK),"VI_MaxAmsduSize", ns.core.UintegerValue (amsduVIBK),
                                    "VO_MaxAmsduSize", ns.core.UintegerValue (amsduVOBE),"BE_MaxAmpduSize", ns.core.UintegerValue (0),
                                    "BK_MaxAmpduSize", ns.core.UintegerValue (0),"VI_MaxAmpduSize", ns.core.UintegerValue (0),"VO_MaxAmpduSize", ns.core.UintegerValue (0))
        elif ca == "Null":	
            self.machelper.SetType ("ns3::StaWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)), "ActiveProbing", ns.core.BooleanValue (False),"BE_MaxAmsduSize", ns.core.UintegerValue (0),
                                    "BK_MaxAmsduSize", ns.core.UintegerValue (0),"VI_MaxAmsduSize", ns.core.UintegerValue (0),
                                    "VO_MaxAmsduSize", ns.core.UintegerValue (0),"BE_MaxAmpduSize", ns.core.UintegerValue (0),
                                    "BK_MaxAmpduSize", ns.core.UintegerValue (0),"VI_MaxAmpduSize", ns.core.UintegerValue (0),"VO_MaxAmpduSize", ns.core.UintegerValue (0))
        else:	
            self.machelper.SetType ("ns3::StaWifiMac", "QosSupported", ns.core.BooleanValue (qosSupported),"Ssid", ns.wifi.SsidValue (ns.wifi.Ssid (ssid)), "ActiveProbing", ns.core.BooleanValue (False))
